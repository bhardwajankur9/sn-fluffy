...
public class HomePagePageTest extends BaseTest {
	...
	public void searchForTextReturnsResults() {
		homePage.searchFor("corona virus").returnsResults().checkSearchTerm("corona virus");
	}
	...
	@Test
	public void toTestExactMatchOfBooksPerPage() {
		homePage.searchFor("Ethnobotany of Asia").matchSearchResults();
